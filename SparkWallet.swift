...
final class SparkWallet: Wallet {
    ...
    func detectWalletInputType(_ input: String) async -> WalletInputType? {
        ...
        case .bolt11Invoice(let d):
            return .bolt11(amountSats: d.amountMsat.map { Int64(truncatingIfNeeded: $0 / 1000) })
        case .lnurlPay(let d):
            return .sparkLnurl(info: ResolvedLnurlInfo(
                minSats: Int64(truncatingIfNeeded: d.minSendable / 1000),
                maxSats: Int64(truncatingIfNeeded: d.maxSendable / 1000),
                label: d.address ?? d.domain
            ))
        case .lightningAddress(let d):
            let pr = d.payRequest
            return .sparkLnurl(info: ResolvedLnurlInfo(
                minSats: Int64(truncatingIfNeeded: pr.minSendable / 1000),
                maxSats: Int64(truncatingIfNeeded: pr.maxSendable / 1000),
